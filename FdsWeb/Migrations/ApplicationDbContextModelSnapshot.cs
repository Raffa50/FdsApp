...
namespace FdsWeb.Migrations {
    ...
    partial class ApplicationDbContextModelSnapshot : ModelSnapshot {
        protected override void BuildModel( ModelBuilder modelBuilder ) {
            modelBuilder.HasAnnotation( "ProductVersion", "1.1.1" ).HasAnnotation( "SqlServer:ValueGenerationStrategy",
            ...
            modelBuilder.Entity( "FdsWeb.Models.Event", b => {
                ...
                b.Property< string >( "ApplicationUserId" ).IsRequired();
            ...
            modelBuilder.Entity( "FdsWeb.Models.UserJoinEvent", b => {
                ...
                b.Property< string >( "Review" ).HasMaxLength( 50 );
            ...
            modelBuilder.Entity( "FdsWeb.Models.Event", b => {
                b.HasOne( "FdsWeb.Models.ApplicationUser", "ApplicationUser" ).WithMany()
                    .HasForeignKey( "ApplicationUserId" ).OnDelete( DeleteBehavior.Cascade );

                b.HasOne( "FdsWeb.Models.EventType", "EventType" ).WithMany( "Events" ).HasForeignKey( "EventTypeId" )
                    .OnDelete( DeleteBehavior.Cascade );
            } );

            modelBuilder.Entity( "FdsWeb.Models.Schedule",
                b => {
                    b.HasOne( "FdsWeb.Models.Event", "Event" ).WithMany( "Schedule" ).HasForeignKey( "EventId" )
                        .OnDelete( DeleteBehavior.Cascade );
                } );

            modelBuilder.Entity( "FdsWeb.Models.UserJoinEvent", b => {
                b.HasOne( "FdsWeb.Models.ApplicationUser", "ApplicationUser" ).WithMany( "UserJoined" )
                    .HasForeignKey( "ApplicationUserId" );

                b.HasOne( "FdsWeb.Models.Event", "Event" ).WithMany( "UserJoined" ).HasForeignKey( "EventId" );

                b.HasOne( "FdsWeb.Models.Schedule", "Schedule" ).WithMany( "UserJoined" ).HasForeignKey( "ScheduleId" );
            } );
            ...
            modelBuilder.Entity( "Microsoft.AspNetCore.Identity.EntityFrameworkCore.IdentityUserClaim<string>",
                b => {
                    b.HasOne( "FdsWeb.Models.ApplicationUser" ).WithMany( "Claims" ).HasForeignKey( "UserId" )
                        .OnDelete( DeleteBehavior.Cascade );
                } );

            modelBuilder.Entity( "Microsoft.AspNetCore.Identity.EntityFrameworkCore.IdentityUserLogin<string>",
                b => {
                    b.HasOne( "FdsWeb.Models.ApplicationUser" ).WithMany( "Logins" ).HasForeignKey( "UserId" )
                        .OnDelete( DeleteBehavior.Cascade );
                } );
            ...
            modelBuilder.Entity( "Microsoft.AspNetCore.Identity.EntityFrameworkCore.IdentityUserRole<string>", b => {
                ...
                b.HasOne( "FdsWeb.Models.ApplicationUser" ).WithMany( "Roles" ).HasForeignKey( "UserId" )
                    .OnDelete( DeleteBehavior.Cascade );
            } );
        }
    }
